...
')
     ...
     */ 
         ...
         * 
         *
         * @see \IziDev\ConditionalField\ConditionalFieldProvider::boot()
         * @param array $fields
         * @param mixed $condition
         * @static 
         */ 
        public static function if($fields, $condition)
        {
                        return \Laravel\Nova\Fields\Field::if($fields, $condition);
        }
